...
export default function GoogleTranslateField() {
  ...
  const detectCurrentLanguage = async (fieldSDK: any, languageCode: string) => {
    try {
      ...
      if (res.data?.detectedLanguage === null) {
        setErrorMsg("Unable to detect language");
      }
      ...
      if (error?.response.data.library === "PEM Routines") {
        setErrorMsg(
          "Error: Please make sure you're including the entire private key"
        );
      }
          ...
          <div className='flex items-center'>
            ...
            <div>
              <button
                ...
                disabled={processing || !needsTranslation}
              >
